...
* [domain-protect audit trust relationship](aws-iam-policies/domain-protect-audit-trust.json) - trust relationship for domain-protect audit role in every AWS account
