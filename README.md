...
* [domain-protect audit trust relationship with External ID](aws-iam-policies/domain-protect-audit-trust.json) for domain-protect audit role in every AWS account
