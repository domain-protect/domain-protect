...
* [domain-protect audit trust relationship](aws-iam-policies/domain-protect-audit-trust.json) - trust relationship without External ID for domain-protect audit role in every AWS account
* [domain-protect audit trust relationship with External ID](aws-iam-policies/domain-protect-audit-trust.json) - trust relationship with External ID for domain-protect audit role in every AWS account
